...
ggscatter(
  ...
  labs(x = "Age (years)", y = "Median slope (a.u./Hz)")

```
regression line without dividing into groups
```{r}
ggscatter(
  slope, x = "age", y = "median_slope", add = "reg.line"
  )+
  stat_regline_equation(
    aes(label =  paste(..eq.label.., ..rr.label.., sep = "~~~~"))
    ) +
  labs(x = "Age (years)", y = "Median slope (a.u./Hz)") + font("axis.title", size = 20) +
