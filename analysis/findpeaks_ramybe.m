...
if nargout > 0
  ...
  signal.internal.findpeaks.plot(x,y,iPk,bPk,bxPk,byPk,wxPk,refW,annotate)
end
...
%--------------------------------------------------------------------------
function [YpkOut,XpkOut,WpkOut,PpkOut,wxPkOut] = assignFullOutputs(y,x,iPk,wxPk,bPk,yIsRow,xIsRow)
coder.internal.prefer_const(yIsRow,xIsRow);
