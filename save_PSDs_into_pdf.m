...
dataDir = dir(['N:\EMP\Elena\Resting state EEG hormones\CleanData\NoMuscle\', '*.set']) % add path where the data lives
fileName = 'afterICA_PSD_ICLabel30.pdf' % pdf file name
